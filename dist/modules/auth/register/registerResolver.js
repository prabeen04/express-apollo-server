...
var registerResolver = {
    Query: {
        hi: function () { return "hi there!"; },
        users: function (parent, args) { return __awaiter(_this, void 0, void 0, function () {
            var users;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, UserSchema_1.default.find()];
                    case 1:
                        users = _a.sent();
                        console.log(users);
                        return [2, users];
    ...
    Mutation: {
        register: function (_, args) { return __awaiter(_this, void 0, void 0, function () {
            var userName, email, password, hashedPassword, newUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userName = args.userName, email = args.email, password = args.password;
                        return [4, bcryptjs.hash(password, 10)];
                    case 1:
                        hashedPassword = _a.sent();
                        return [4, UserSchema_1.default.create({
                                userName: userName,
                                email: email,
